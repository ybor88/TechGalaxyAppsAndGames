...
set "APP_ID=com.example.playerbase"
set "MAIN_ACTIVITY=com.example.playerbase.MainActivity"
...
if "%DRY_RUN%"=="1" (
  ...
  echo [DRY-RUN] copy "%APK_PATH%" "%PROJECT_DIR%\PlayerBase.apk"
) else (
  ...
  echo [INFO] Aggiorno PlayerBase.apk nella root del progetto...
  copy /Y "%APK_PATH%" "%PROJECT_DIR%\PlayerBase.apk" >nul
  echo [OK] APK aggiornato: %PROJECT_DIR%\PlayerBase.apk
