...
fun AgeStatsScreen(
    ...
    val ageCounts = remember(players, selectedSport) {
        viewModel.ageCounts(selectedSport)
    }

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Statistiche Età") },
                navigationIcon = {
        ...
        Column(
            ...
            Text("Età (giocatori per anni compiuti)", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
