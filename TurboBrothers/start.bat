...
set "APP_ID=com.example.turbobrothers"
set "MAIN_ACTIVITY=com.example.turbobrothers.MainActivity"
...
if "%DRY_RUN%"=="1" (
  ...
  echo [DRY-RUN] copy "%APK_PATH%" "%PROJECT_DIR%\TurboBrothers.apk"
) else (
  ...
  echo [INFO] Aggiorno TurboBrothers.apk nella root del progetto...
  copy /Y "%APK_PATH%" "%PROJECT_DIR%\TurboBrothers.apk" >nul
  echo [OK] APK aggiornato: %PROJECT_DIR%\TurboBrothers.apk
