...
set "APP_ID=com.volcanoescape.app"
set "MAIN_ACTIVITY=com.volcanoescape.app.MainActivity"
...
if "%DRY_RUN%"=="1" (
  ...
  echo [DRY-RUN] copy "%APK_PATH%" "%PROJECT_DIR%\VolcanoEscape.apk"
) else (
  ...
  echo [INFO] Aggiorno VolcanoEscape.apk nella root del progetto...
  copy /Y "%APK_PATH%" "%PROJECT_DIR%\VolcanoEscape.apk" >nul
  echo [OK] APK aggiornato: %PROJECT_DIR%\VolcanoEscape.apk
