...
async def init_db() -> None:
    ...
    from app.models import centri_costo  # noqa: F401 — registra modelli Centri di Costo
    from app.models import prodotti  # noqa: F401 — registra modelli Prodotti/Distinta base
    from app.models import commesse  # noqa: F401 — registra modelli Commesse
    from app.models import controllo_gestione  # noqa: F401 — registra modelli Controllo di gestione
