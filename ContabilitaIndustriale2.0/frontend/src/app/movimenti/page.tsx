    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col">
      ...
      <header className="bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center gap-4">
          <Link href="/" className="flex items-center gap-3 focus:outline-none">
            <Image src="/logo.jpeg" alt="Contabilità Industriale 2.0" width={44} height={44} className="rounded-xl object-contain" priority />
            <div>
      ...
      <footer className="border-t border-gray-100 py-5">
        <div className="flex items-center justify-center gap-2">
          <Image src="/logo.jpeg" alt="Contabilità Industriale 2.0" width={22} height={22} className="rounded opacity-60" />
          <p className="text-xs text-gray-300">Contabilità Industriale 2.0 — v1.0.0 — 100% open source, 0€</p>
        </div>
      </footer>
    </div>
  );
