...
const MODULI = [
  ...
  {
    id: 11,
    titolo: "Centri di Costo",
    descrizione: "Centri produttivi, ausiliari e comuni. Basi di riparto e ribaltamento dei costi indiretti.",
    icona: Factory,
    href: "/centri-costo",
    attivo: true,
    colore: "cyan",
  ...
  {
    id: 12,
    titolo: "Prodotti e Distinta Base",
    descrizione: "Materie prime, semilavorati e prodotti finiti. Distinta base (BOM) e costo standard.",
    icona: Boxes,
    href: "/prodotti",
    attivo: true,
    colore: "lime",
  ...
  {
    id: 13,
    titolo: "Magazzino Industriale",
    descrizione: "Carichi e scarichi, giacenze e valorizzazione a costo medio ponderato.",
    icona: Warehouse,
    href: "/magazzino",
    attivo: true,
    colore: "sky",
  },
  {
    id: 14,
    titolo: "Commesse",
    descrizione: "Costi diretti e indiretti per commessa (job order costing) e riepilogo consuntivo.",
    icona: ClipboardList,
    href: "/commesse",
    attivo: true,
    colore: "rose",
  ...
  {
    id: 15,
    titolo: "Costi Standard & Scostamenti",
    descrizione: "Confronto standard vs consuntivo, scostamento di prezzo, quantità ed efficienza.",
    icona: GitCompare,
    href: "/scostamenti",
    attivo: true,
    colore: "fuchsia",
  },
  {
    ...
    descrizione: "Direct costing, margine di contribuzione e punto di pareggio (break-even).",
    icona: Gauge,
...
const COLOR_MAP: Record<string, { ring: string; icon: string; badge: string }> = {
  ...
  cyan:    { ring: "group-hover:ring-cyan-400",    icon: "text-cyan-600 bg-cyan-50",       badge: "bg-cyan-500" },
  lime:    { ring: "group-hover:ring-lime-400",    icon: "text-lime-600 bg-lime-50",       badge: "bg-lime-500" },
  sky:     { ring: "group-hover:ring-sky-400",     icon: "text-sky-600 bg-sky-50",         badge: "bg-sky-500" },
  rose:    { ring: "group-hover:ring-rose-400",    icon: "text-rose-600 bg-rose-50",       badge: "bg-rose-500" },
  fuchsia: { ring: "group-hover:ring-fuchsia-400", icon: "text-fuchsia-600 bg-fuchsia-50", badge: "bg-fuchsia-500" },
  slate:   { ring: "group-hover:ring-slate-400",   icon: "text-slate-700 bg-slate-100",    badge: "bg-slate-600" },
};
    ...
    <div className="min-h-screen bg-[#f8fafc] flex flex-col">
      ...
      <header className="bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <Image
            src="/logo.jpeg"
            alt="Contabilità Industriale 2.0 logo"
            width={52}
            height={52}
          ...
          <div>
            <h1 className="text-xl font-bold leading-none">
              ...
              <span className="text-[#0e7490]">Industriale</span>{" "}
              <span className="text-[#f97316]">2</span>
              <span className="text-[#16a34a]">.</span>
              <span className="text-[#f59e0b]">0</span>
            </h1>
            <p className="text-xs text-gray-400 mt-0.5">ERP industriale 100% open source · Contabilità analitica e controllo di gestione</p>
          </div>
        </div>
      </header>
      ...
      <footer className="border-t border-gray-100 py-5">
        <div className="flex flex-col items-center justify-center gap-1">
          <div className="flex items-center gap-2">
            <Image
              src="/logo.jpeg"
              alt="Contabilità Industriale 2.0"
              width={22}
              height={22}
              className="rounded opacity-60"
            />
            <p className="text-xs text-gray-300">
              Contabilità Industriale 2.0 — v1.0.0 — 100% open source, 0€
            </p>
          </div>
