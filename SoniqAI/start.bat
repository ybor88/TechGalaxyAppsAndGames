...
set "APP_ID=com.soniqai.app"
set "MAIN_ACTIVITY=com.soniqai.app.MainActivity"
...
if "%DRY_RUN%"=="1" (
  ...
  echo [DRY-RUN] copy "%APK_PATH%" "%PROJECT_DIR%\SoniqAI.apk"
) else (
  ...
  echo [INFO] Aggiorno SoniqAI.apk nella root del progetto...
  copy /Y "%APK_PATH%" "%PROJECT_DIR%\SoniqAI.apk" >nul
  echo [OK] APK aggiornato: %PROJECT_DIR%\SoniqAI.apk
