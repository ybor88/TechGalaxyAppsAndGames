...
set "APP_ID=com.scouttable.app"
set "MAIN_ACTIVITY=com.scouttable.app.MainActivity"
...
if "%DRY_RUN%"=="1" (
  ...
  echo [DRY-RUN] copy "%APK_PATH%" "%PROJECT_DIR%\ScoutTable.apk"
) else (
  ...
  echo [INFO] Aggiorno ScoutTable.apk nella root del progetto...
  copy /Y "%APK_PATH%" "%PROJECT_DIR%\ScoutTable.apk" >nul
  echo [OK] APK aggiornato: %PROJECT_DIR%\ScoutTable.apk
