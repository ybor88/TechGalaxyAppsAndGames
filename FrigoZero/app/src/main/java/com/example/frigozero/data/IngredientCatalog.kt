...
object IngredientCatalog {
    ...
    private val aliasesByCanonical = mapOf(
        ...
        "pomodoro" to setOf("tomato", "tomatoes", "pomodoro", "pomodori", "cherry tomato", "cherry tomatoes", "tomato plant", "roma tomato", "nightshade", "solanum lycopersicum"),
        "peperone" to setOf("pepper", "bell pepper", "peperone", "peperoni", "capsicum", "red pepper", "yellow pepper", "green pepper"),
        "cipolla" to setOf("onion", "onions", "cipolla", "cipolle", "red onion", "spring onion", "shallot", "allium", "bulb vegetable"),
        ...
        "pollo" to setOf("chicken", "pollo", "chicken breast", "chicken leg", "chicken wing", "chicken thigh", "roast chicken", "poultry", "fowl"),
        "lattuga" to setOf("lettuce", "lattuga", "insalata", "leaf vegetable", "leafy vegetable", "salad green", "salad leaf"),
        "cetriolo" to setOf("cucumber", "cetriolo", "cetrioli"),
        "limone" to setOf("lemon", "limone", "limoni"),
        "carota" to setOf("carrot", "carota", "carote", "baby carrot", "carrot stick", "root vegetable", "daucus carota"),
        "patata" to setOf("potato", "potatoes", "patata", "patate", "sweet potato", "russet potato", "tuber"),
        "sedano" to setOf("celery", "sedano"),
        "brodo" to setOf("broth", "stock", "brodo"),
        "riso" to setOf("rice", "riso", "grain", "cereal grain", "white rice", "brown rice"),
        ...
        "oliva" to setOf("olive", "olives", "oliva", "olive nere", "olive verdi", "black olive", "black olives", "green olive", "green olives"),
        ...
        "mela" to setOf("apple", "apples", "mela", "mele", "granny smith", "red delicious", "golden delicious", "fuji apple", "apple fruit", "cooking apple", "green apple", "red apple", "apple tree", "malus"),
        "yogurt" to setOf("yogurt", "yoghurt"),
        "mozzarella" to setOf("mozzarella"),
        "arancia" to setOf("orange", "oranges", "arancia", "arance", "navel orange", "blood orange", "mandarin", "clementine", "citrus", "citrus fruit", "citrus sinensis"),
        "limone" to setOf("lemon", "lemons", "limone", "limoni", "lemon fruit", "lime"),
        ...
        "broccoli" to setOf("broccoli", "broccolo", "brassica", "cruciferous vegetable"),
        "cavolfiore" to setOf("cauliflower", "cavolfiore"),
        "fagiolo" to setOf("bean", "beans", "fagiolo", "fagioli", "legume", "legumes"),
        ...
        "manzo" to setOf("beef", "manzo", "red meat", "steak", "ground beef", "minced beef"),
        ...
        "fragola" to setOf("strawberry", "strawberries", "fragola", "fragole", "berry", "berries", "garden strawberry"),
        "lampone" to setOf("raspberry", "raspberries", "lampone", "lamponi"),
        "pesca" to setOf("peach", "peaches", "pesca", "pesche", "stone fruit", "drupe"),
        ...
        "noce" to setOf("walnut", "walnuts", "noce", "noci", "nut", "tree nut"),
    ...
    private val apiIngredientByCanonical = mapOf(
        ...
        "melanzana" to "aubergine",
        "broccoli" to "broccoli",
        "cavolfiore" to "cauliflower",
        "fagiolo" to "borlotti beans",
        "lenticchia" to "lentils",
        "mais" to "corn",
        "pisello" to "peas",
        "gambero" to "shrimp",
        "salsiccia" to "sausages",
        "prosciutto" to "ham",
        "pancetta" to "bacon",
        "manzo" to "beef",
        "maiale" to "pork",
        ...
        "mandorla" to "almonds",
        "noce" to "walnuts",
        "nocciola" to "shelled hazelnuts",
        "pinolo" to "pine nuts",
        "uvetta" to "raisins",
        "miele" to "honey",
        "cioccolato" to "dark chocolate",
        "vaniglia" to "vanilla",
        ...
        "olio di sesamo" to "sesame seed oil",
        "tahini" to "tahini",
        "pesto" to "pesto",
        "polpo" to "octopus",
        "calamaro" to "squid",
        ...
        "bresaola" to "bresaola",
        "speck" to "speck",
        "mortadella" to "mortadella",
        "coppa" to "coppa",
