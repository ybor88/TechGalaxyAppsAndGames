...
set "APP_ID=com.opticpro.suite"
set "MAIN_ACTIVITY=com.opticpro.suite.MainActivity"
...
if "%DRY_RUN%"=="1" (
  ...
  echo [DRY-RUN] copy "%APK_PATH%" "%PROJECT_DIR%\OpticProSuite.apk"
) else (
  ...
  echo [INFO] Aggiorno OpticProSuite.apk nella root del progetto...
  copy /Y "%APK_PATH%" "%PROJECT_DIR%\OpticProSuite.apk" >nul
  echo [OK] APK aggiornato: %PROJECT_DIR%\OpticProSuite.apk
