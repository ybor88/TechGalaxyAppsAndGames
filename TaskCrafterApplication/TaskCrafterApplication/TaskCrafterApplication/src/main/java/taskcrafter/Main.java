            ...
            taskList.setCellRenderer(new DefaultListCellRenderer() {
                ...
                public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                    ...
                    if (value instanceof Task) {
                        ...
                        cellPanel.add(prioritaLabel, BorderLayout.EAST);
                    }
                            ...
                            confermaButton.addActionListener(new ActionListener() {
                                ...
                                public void actionPerformed(ActionEvent e) {
                                    try {
                                        ...
                                        selectedTask.setScadenza(calData.getTime().toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime());
                                        List<String> etichette = new ArrayList<>();
                                        for (String et : etichetteField.getText().split(",")) {
                                            if (!et.trim().isEmpty()) etichette.add(et.trim());
                                        }
