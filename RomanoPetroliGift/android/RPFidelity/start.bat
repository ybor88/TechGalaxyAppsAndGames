...
set "APP_ID=com.romanopetroli.rpfidelity"
set "MAIN_ACTIVITY=com.romanopetroli.rpfidelity.MainActivity"
...
if "%DRY_RUN%"=="1" (
  ...
  echo [DRY-RUN] copy "%APK_PATH%" "%PROJECT_DIR%\RPFidelity.apk"
) else (
  ...
  echo [INFO] Aggiorno RPFidelity.apk nella root del progetto...
  copy /Y "%APK_PATH%" "%PROJECT_DIR%\RPFidelity.apk" >nul
  echo [OK] APK aggiornato: %PROJECT_DIR%\RPFidelity.apk
