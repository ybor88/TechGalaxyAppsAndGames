...
$router->get('/admin/messaggi', [new AdminController(), 'messaggi']);
$router->get('/admin/messaggi/thread', [new AdminController(), 'messaggioThread']);
$router->post('/admin/messaggi/rispondi', [new AdminController(), 'rispondiMessaggio']);
$router->get('/admin/dipendenti', [new AdminController(), 'dipendenti']);
$router->get('/admin/dipendenti/nuovo', [new AdminController(), 'nuovoDipendenteForm']);
$router->post('/admin/dipendenti/nuovo', [new AdminController(), 'nuovoDipendente']);
$router->get('/admin/dipendenti/modifica', [new AdminController(), 'modificaDipendenteForm']);
$router->post('/admin/dipendenti/modifica', [new AdminController(), 'modificaDipendente']);
$router->post('/admin/dipendenti/elimina', [new AdminController(), 'eliminaDipendente']);
